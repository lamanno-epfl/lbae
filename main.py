...
The app will then run on http://cajal.epfl.ch:8050/ . Note that we only use one worker, as each
additional worker will drastically increase the memory usage.

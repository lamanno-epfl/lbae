            ...
            html.Div(
                children=[
                    ...
                    dmc.Chips(
                        id="main-brain",
                        data=[
                            {"value": "ReferenceAtlas", "label": "Reference 1 (M)"},
                            {"value": "SecondAtlas", "label": "Reference 2 (M)"},
                            {"value": "Male1", "label": "Control 1 (M)"},
                            {"value": "Male2", "label": "Control 2 (M)"},
                            {"value": "Male3", "label": "Control 3 (M)"},
                            {"value": "Female1", "label": "Control 4 (F)"},
                            {"value": "Female2", "label": "Control 5 (F)"},
                            {"value": "Female3", "label": "Control 6 (F)"},
